...
export default function FillInTheBlank(props) {
  ...
  return (
    <>
      ...
      <p>
        <label>
          <input type="radio" name={"question_" + props.index} value="true" onChange={e => handleChange(true)} />
          True
          <br />
        </label>
        <label>
          <input type="radio" name={"question_" + props.index} value="false" onChange={e => handleChange(false)}/>
          False
          <br />
        </label>
      </p>
